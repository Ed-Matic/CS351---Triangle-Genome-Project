/**
 * Ederin Igharoro
 * This class is made to hold set Constants fro
 * the entire Triangle Genome project. These
 * variables do not change nor do their numbers.
 */
package mainPackage;
...
{
  /**
   * The amount of triangles used for a genome
   */
  ...
  /**
   * The default initial population size for a tribe
   */
